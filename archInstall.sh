...
function cfg_system(){
    ...
    # set host file,Crow is your hostname
    arch_chroot "echo 'Crow' > /etc/hostname"
    arch_chroot "echo '127.0.0.1   localhost' >> /etc/hosts"
    arch_chroot "echo '::1         localhost' >> /etc/hosts"
    arch_chroot "echo '127.0.0.1   Crow.localdomain  Crow' >> /etc/hosts"
    arch_chroot "echo '140.82.113.4       github.com' >> /etc/hosts"
    arch_chroot "echo '199.232.28.133     githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '199.232.28.133     raw.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '192.30.253.112     github.com' >> /etc/hosts"
    arch_chroot "echo '192.30.253.113     github.com' >> /etc/hosts"
    arch_chroot "echo '192.30.253.119     gist.github.com' >> /etc/hosts"
    arch_chroot "echo '192.30.255.112     github.com git ' >> /etc/hosts"
    arch_chroot "echo '151.101.185.194    github.global.ssl.fastly.net' >> /etc/hosts"
    arch_chroot "echo '151.101.88.249     github.global.ssl.fastly.net' >> /etc/hosts"
    arch_chroot "echo '151.101.100.133    assets-cdn.github.com' >> /etc/hosts"
    arch_chroot "echo '151.101.100.133    raw.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '185.31.16.184      github.global.ssl.fastly.net' >> /etc/hosts"
    arch_chroot "echo '52.74.223.119      github.com' >> /etc/hosts"
    arch_chroot "echo '192.30.253.119     gist.github.com' >> /etc/hosts"
    arch_chroot "echo '54.169.195.247     api.github.com' >> /etc/hosts"
    arch_chroot "echo '185.199.111.153    assets-cdn.github.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     raw.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.108.133    user-images.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     gist.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     cloud.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     camo.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars0.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars1.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars2.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars3.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars4.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars5.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars6.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars7.githubusercontent.com' >> /etc/hosts"
    arch_chroot "echo '151.101.76.133     avatars8.githubusercontent.com' >> /etc/hosts"
    # set nvim editor
